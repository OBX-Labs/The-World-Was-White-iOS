...
@synthesize animating, animationFrameInterval, displayLink, animationTimer, white;
...
- (void) setup
{
    ...
    text = [[OKTextObject alloc] initWithText:textFile withTessFont:font andCanvasSize:self.frame.size];
    ...
    for(UITouch *touch in touches)
    {
        ...
        if(fID == -1)
        {
            ...
            if(nfID != -1)
            {
                ...
                [white touchesBegan:nfID atPosition:CGPointMake(pt.x, (self.frame.size.height - pt.y))];
            }
        }
    }
...
{    
    for(UITouch *touch in touches)
    {
        ...
        {
            CGPoint pt = [touch locationInView:self];
            [white touchesMoved:fID atPosition:CGPointMake(pt.x, (self.frame.size.height - pt.y))];
        }
    }
}
...
{   
    for(UITouch *touch in touches)
    {
        ...
        {
            CGPoint pt = [touch locationInView:self];
            [white touchesEnded:fID atPosition:CGPointMake(pt.x, (self.frame.size.height - pt.y))];
...
{    
    for(UITouch *touch in touches)
    {
        ...
        {
            CGPoint pt = [touch locationInView:self];
            [white touchesCancelled:fID atPosition:CGPointMake(pt.x, (self.frame.size.height - pt.y))];
